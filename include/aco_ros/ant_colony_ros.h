...
/* Intelligent Control and Guidance Lab
 * Website: 
 * Contact: 
 *
 * Copyright (c) 2014
...
class AcoPlanner : public nav_core::BaseGlobalPlanner
{
public:
  AcoPlanner(ros::NodeHandle &nh); //this constructor is may be not needed
  AcoPlanner();
  ~AcoPlanner();
  AcoPlanner(std::string name, costmap_2d::Costmap2DROS *costmap_ros);
  ...
  vector<int> AcoPlannerROS(int startCell, int goalCell);
